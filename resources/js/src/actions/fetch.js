...
// const URL='www.yktk435.live-on.net'
/**********************************************/
// プロフィールでのユーザ情報取得
/**********************************************/
...
export const getUserInfoInPrrofile = (userId) => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/member/' + userId + '/edit', option);
...
export const getTimeLine = () => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/article/show/edit', option)
      const data = await responce.json();
...
export const getFriends = (userId) => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/friend?userId=' + userId, option)
      const data = await responce.json();
...
export const followOr = (e, memberId) => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/friend/' + e, option)
      const data = await responce.json();
...
export const search = (keyword) => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/member?keyword=' + encodeURI(keyword), option)
      const data = await responce.json();
...
export const saveChanges = (postData, token) => {
  return async (dispatch, getState) => {
    ...
    // dispatch(startRequest(category)); // categoryIdからcategoryに変更
    try {
      const responce = await fetch(URL+'/api/member/' + postData.id, option);
      const data = await responce.json();
...
export const pushCreateAccountButton = (data) => {
  ...
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/member', option);
      const data = await responce.json();
...
export const post = (requestData) => {
  return async (dispatch, getState) => {
    ...
    // dispatch(startRequest(category)); // categoryIdからcategoryに変更
    try {
      const responce = await fetch(URL+'/api/article', option);
      const data = await responce.json();
...
export const postRep = (repArticleId, content) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(URL+'/api/comment', option);
...
export const getArticles = (userId) => {
  return async (dispatch, getState) => {
    ...
    try {
      const responce = await fetch(URL+'/api/article?userId=' + userId, option);
      const data = await responce.json();
      if ('error' in data) throw data
...
export const startLogin = (ipassData) => {
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const responce = await fetch(URL+'/api/login', option);
      const data = await responce.json();
...
export const getOtherUserInfo = (userId) => {
  return async (dispatch, getState) => {
    ...
    // ログインしていなければloginにリダイレクトの処理を書く
    try {
      const responce = await fetch(URL+'/api/member/get_other_user/edit', option);
      const data = await responce.json();
...
export const getArticleInfo = (articleId) => {
  return async (dispatch, getState) => {
    ...
    // ログインしていなければloginにリダイレクトの処理を書く
    try {
      const responce = await fetch(URL+'/api/article/' + articleId, option);
      const data = await responce.json();
...
export const goodToggle = (articleId) => {
  return async (dispatch, getState) => {
    ...
    // ログインしていなければloginにリダイレクトの処理を書く
    try {
      const responce = await fetch(URL+'/api/good/' + articleId + '/edit', option);
      const data = await responce.json();
...
export const getDm = () => {
  return async (dispatch, getState) => {
    ...
    // ログインしていなければloginにリダイレクトの処理を書く
    try {
      const responce = await fetch(URL+'/api/message', option);
      const data = await responce.json();
...
export const profileChange = (data) => {
  return async (dispatch, getState) => {
    ...
    // dispatch(startRequest(category)); // categoryIdからcategoryに変更
    try {
      const responce = await fetch(URL+'/api/member/profilechange/', option);
      const data = await responce.json();
